...
{
    public class SequenceComplainService : MongoBaseService<SequenceComplain, SequenceComplainDto>, ISequenceComplainService
    {
        private readonly ISequenceComplainRepository _repository;

        public SequenceComplainService(ISequenceComplainRepository repos, IMapper mapper, IUserPrincipalService userPrincipalService) : base(repos, mapper, userPrincipalService)
        {
            _repository = repos;
        }
