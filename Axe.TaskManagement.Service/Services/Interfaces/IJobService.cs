...
namespace Axe.TaskManagement.Service.Services.Interfaces
{
    public interface IJobService : IMongoBaseService<Job, JobDto>
    {
        ...
        Task<GenericResponse<List<JobDto>>> GetListJobForUser(ProjectDto project, string actionCode, int metaId, Guid docTypeFieldInstanceId, string parallelInstanceIds, string accessToken = null);
