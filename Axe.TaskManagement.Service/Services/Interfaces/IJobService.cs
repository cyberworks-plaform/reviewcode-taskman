...
namespace Axe.TaskManagement.Service.Services.Interfaces
{
    public interface IJobService : IMongoBaseService<Job, JobDto>
    {
        ...
        Task<GenericResponse<int>> GetListJobCheckFinalBounced(Guid projectInstanceId, string path, Guid userInstanceId);
        ...
        Task<GenericResponse<List<SummaryTotalDocPathJob>>> GetSummaryFolder(Guid projectInstanceId, string pathIds, string syncMetaPaths, string accessToken = null);
